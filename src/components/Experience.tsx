...
const WorkExperience = () => {
  return (
    <div className="space-y-8 mb-12 md:mb-24">
      <SectionTitle text="Work" emphasis="Experience" />
      <div>
        {workExperience.map((experience) => (
          <div key={experience.title} className=" relative pb-8 space-x-4 after work-experience-wrapper">
            ...
            <div className="pl-14 md:pl-16 space-y-2">
              ...
              <ul className=" flex flex-wrap">
                {experience.skills.map((skill) => (
                  <span key={skill} className=" bg-primary/20 text-xs mb-2  text-primary py-1.5 px-4 rounded-3xl mr-2 block">
                    {skill}
                  </span>
                ))}
              </ul>
